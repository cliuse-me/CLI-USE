...
export const AVAILABLE_MODELS = [
    { label: 'Claude 3.7 Sonnet (Anthropic)', value: 'claude-3-7-sonnet-20250219', provider: 'anthropic', pkg: '@ai-sdk/anthropic' },
    { label: 'GPT-4o (OpenAI)', value: 'gpt-4o', provider: 'openai', pkg: '@ai-sdk/openai' },
    { label: 'Gemini 1.5 Pro (Google)', value: 'gemini-1.5-pro-latest', provider: 'google', pkg: '@ai-sdk/google' },
    { label: 'Llama 3 70B (Groq)', value: 'llama3-70b-8192', provider: 'groq', pkg: '@ai-sdk/groq' },
    { label: 'Local Llama 3 (Ollama)', value: 'llama3', provider: 'ollama', pkg: 'ollama-ai-provider' },
] as const;
    ...
    try {
        switch (config.provider) {
            ...
            case 'google': {
                ...
                return createGoogleGenerativeAI({ apiKey: keyManager.getNextKey() })(config.modelId);
            }
            case 'groq': {
