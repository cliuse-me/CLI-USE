  ...
  return {
    config: async (cfg: any) => {
      ...
      cfg.agent["cli-use-planner"] = {
        ...
        prompt:
          "You are the CLI Use Planner. Analyze requirements, read files, and design a comprehensive plan. When the plan is ready, save it using the `save_plan` tool. You cannot write code. Do not attempt to modify files directly.",
        permission: {
          edit: "deny",
        },
      };
      ...
      cfg.agent["cli-use-implementer"] = {
        ...
        prompt:
          "You are the CLI Use Implementer. Read the plan saved by the planner and implement the code according to the plan.",
      };
      ...
      cfg.command.propose = {
        ...
        template:
          "Act as the CLI Use Planner. Analyze the following request and create a detailed plan using the save_plan tool: $ARGUMENTS",
      };
      ...
      cfg.command.implement = {
        ...
        template:
          "Act as the CLI Use Implementer. Read the latest plan and implement it. $ARGUMENTS",
      };
    },
